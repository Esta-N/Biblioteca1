            ...
            <div class="col-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="views/listado.php" class="btn btn-primary">Ver Libros</a>
                    </div>   
                </div>
            </div>
            ...
            <div class="col-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="views/viewSocios.php" class="btn btn-primary">Ver Socios</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="views/viewPrestamos.php" class="btn btn-primary">Ver Prestamos</a>
                    </div>
                </div>
            </div>
        </div>
